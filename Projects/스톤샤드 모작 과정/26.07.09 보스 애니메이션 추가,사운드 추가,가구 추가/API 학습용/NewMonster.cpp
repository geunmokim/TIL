...
CNewMonster::CNewMonster()
	:m_iSrcCX(0), m_iSrcCY(0),m_iAtk(0),m_bFlipX(false),m_iExp(0)
{
...
void CNewMonster::Play_DeathSound()
{
	CSoundMgr::Get_Instance()->PlaySound(_T("snd_human_death_2.wav"), CSoundMgr::MONSTER);
}