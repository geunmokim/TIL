...
public:
	...
	//화면 흔들림 연출용
	float Get_ShakeScrollX() { return m_fScrollX + m_fShakeOffsetX; }
	float Get_ShakeScrollY() { return m_fScrollY + m_fShakeOffsetY; }
...
public:
	...
	void Start_Shake(float _fIntensity, DWORD _dwDuration);
public:
...
private:
	...
	//화면 흔들기용 
	float m_fShakeIntensity; //얼마나 세게 흔들지
	DWORD m_dwShakeEndTime;  //언제까지 흔들지
