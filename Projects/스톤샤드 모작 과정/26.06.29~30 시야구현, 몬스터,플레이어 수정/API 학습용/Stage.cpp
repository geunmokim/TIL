...
void CStage::Initialize()
{
	...
	CObj* pMonster = CAbFactory<CMonster_Melee>::Create();
	CObjMgr::Get_Instance()->Add_Object(OBJID::MONSTER, pMonster);
	CObjMgr::Get_Instance()->Add_Object(RENDERID::OBJECT, pMonster);
