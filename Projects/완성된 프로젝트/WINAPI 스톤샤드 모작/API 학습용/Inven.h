...
public:
	bool Is_Open() { return m_bOpen; }
	CItem* Get_WeaponItem() { return m_pWeaponItem; }
	CItem* Get_ArmorItem() { return m_pArmorItem; }
	CItem* Get_HatItem() { return m_pHatItem; }
...
private:
	...
	//무기/방어구(갑옷,모자) 드래그·장착 사운드
	void Play_EquipSound(ITEM_TYPE _eType);
